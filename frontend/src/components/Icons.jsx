...
// Download Icon — Tray with down arrow
export function IconDownload({ size = 20, color = "#28a745", className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={{ display: 'inline-block', verticalAlign: 'middle' }}>
...
// Copy Icon — Overlapping document clipboards
export function IconCopy({ size = 18, color = "#64748b", className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={{ display: 'inline-block', verticalAlign: 'middle' }}>
...
// Checkmark Icon — For Copied indicator
export function IconCheck({ size = 18, color = "#16a34a", className = "" }) {
  return (
